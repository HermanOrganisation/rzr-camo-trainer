...
export const CAMO_COMPONENTS: CamoComponent[] = [
  ...
  {
    id: "front-wheel-case-left",
    code: "06",
    name: "Front Wheel Case Left-MRZR",
    shortName: "Front Wheel Case L",
    partNumber: "9001-0426-US",
    region: { left: 3.5, top: 57.5, width: 17, height: 24 },
    skeletonRegion: { left: 3.5, top: 57.5, width: 17, height: 24 },
    detached: { x: -26, y: 16, rotate: -8 },
    hotspot: { x: 12, y: 69.5 },
    layer: 6,
    estTime: "02:15",
    difficulty: "BASIC",
    videoUrl: null,
    steps: [
      "Release the wheel case perimeter retention cord.",
      "Unclip the case from the wheel structure standoffs.",
      "Draw the case outward off the wheel skeleton.",
      "Lift the case clear of the suspension arm.",
      "Inspect the cord and standoffs before storage or reinstallation.",
    ],
  },
  {
    id: "front-wheel-case-right",
    code: "07",
    name: "Front Wheel Case Right-MRZR",
    shortName: "Front Wheel Case R",
    partNumber: "9001-0422-US",
    region: { left: 79.5, top: 57.5, width: 17, height: 24 },
    skeletonRegion: { left: 79.5, top: 57.5, width: 17, height: 24 },
    detached: { x: 26, y: 16, rotate: 8 },
    hotspot: { x: 88, y: 69.5 },
    layer: 7,
    estTime: "02:15",
